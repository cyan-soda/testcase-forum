            ...
            <div className="relative mx-auto flex w-full max-w-[1440px] flex-row items-center justify-start">
                ...
                <div className="flex flex-row gap-[10px] ml-10 justify-start flex-grow">
                    {NAV_ITEMS.map((item) => (
                        <button 
                            key={item.id}
                            className={`flex items-center justify-center px-8 py-[10px] rounded-lg text-lg leading-6 font-semibold ${
                                activeLink === item.link ? 'text-white bg-black' : 'text-black bg-white'
